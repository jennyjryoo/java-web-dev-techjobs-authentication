...
public class AuthenticationController {
    ...
    public String processRegistrationForm (@ModelAttribute @Valid RegisterFormDTO registerFormDTO, Errors errors, HttpServletRequest request, Model model) {
        ...
        if (!password.equals(verifyPassword)) {
            errors.rejectValue("password","passwords.mismatch","Passwords must match.");
            model.addAttribute("title","Register a New User");
            return "register";
        }
    ...
    public String processLoginForm (@ModelAttribute @Valid LoginFormDTO loginFormDTO, Errors errors, HttpServletRequest request, Model model) {
        ...
        if (theUser == null) {
            errors.rejectValue("username","username.invalid","This username does not exist.");
            model.addAttribute("title","Log In");
            return "login";
        }
        ...
        if (!theUser.isMatchingPassword(password)) {
            errors.rejectValue("password","password.mismatch","Invalid password.");
            model.addAttribute("title","Log In");
            return "login";
        }
